...
setInterval(() => {
	fetch("https://gasstation-mainnet.matic.network/").then(r => r.json()).then((r) => {
		...
		gasPriceGwei = gasPriceGwei < MIN_GAS_PRICE_GWEI ? MIN_GAS_PRICE_GWEI : gasPriceGwei;
		gasPriceGwei = gasPriceGwei > MAX_GAS_PRICE_GWEI ? MAX_GAS_PRICE_GWEI : gasPriceGwei;
